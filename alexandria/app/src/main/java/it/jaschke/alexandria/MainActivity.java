...
public class MainActivity extends ActionBarActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks, Callback {
    ...
    public void showNoBookFoundDialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage(R.string.no_book_found_dialogue_content_text)
                .setTitle(R.string.no_book_found_dialogue_title_text);
    ...
    public void goBack(View view){
        ...
        //Bug Fixed: when deleting a book the list view fragment should be loaded
        getSupportFragmentManager().beginTransaction()
